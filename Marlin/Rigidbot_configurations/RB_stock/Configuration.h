...
// for dual extruders also set HOTEND_OFFSET and X_DUAL_REDUCTION below
...
#define HOTEND_OFFSET_X {0.0, 36.00} // (in mm) for each extruder, offset of the hotend on the X axis -Rigidbot dual
//#define HOTEND_OFFSET_X {0.0, 34.00} // (in mm) for each extruder, offset of the hotend on the X axis -Peter Stoneham dual
...
#define TEMP_SENSOR_0 1 // DGlass3D = 5; RigidBot = 1; E3D-V6 = 5
#define TEMP_SENSOR_1 0  // set this for a dual extruder, otherwise leave as 0
...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  // Rigidbot(RB1) hotend (PID Autotune didn't work)
  #define  DEFAULT_Kp 16.17
  #define  DEFAULT_Ki 0.85
  #define  DEFAULT_Kd 76.55

  // RigidBot(RB2) hotend (PID Autotune didn't work)
  ...
  // E3D Stoneham single/dual alloy mount
  //#define  DEFAULT_Kp 38.6
  //#define  DEFAULT_Ki 3.96
  //#define  DEFAULT_Kd 94.2
...
// reduced x travel from larger extruder carriage
// single extruder
#define X_DUAL_REDUCTION 0
// RB dual extruder
//define X_DUAL_REDUCTION 57
// Peter Stoneham Dual extruder
//#define X_DUAL_REDUCTION 32

// You can tweak these values if you have modified your bed
// or to account for the precise location of your end-stop switches and idler pulleys.
#ifdef RIGIDBOT_BIG
  #define X_MAX_POS (406 - X_DUAL_REDUCTION)  // RigidBot regular is 254mm, RigidBot Big is 406mm
  #define Y_MAX_POS (304 - X_DUAL_REDUCTION)  // RigidBot regular is 248mm, RigidBot Big is 304mm
  #define Z_MAX_POS (254 - X_DUAL_REDUCTION)  // RigidBot regular and Big are 254mm,  XL is 355mm
#else
  #define X_MAX_POS (254 - X_DUAL_REDUCTION)  // RigidBot regular is 254mm, RigidBot Big is 406mm
  #define Y_MAX_POS (248 - X_DUAL_REDUCTION)  // RigidBot regular is 248mm, RigidBot Big is 304mm
  #define Z_MAX_POS (254 - X_DUAL_REDUCTION)  // RigidBot regular and Big are 254mm, XL is 355mm
#endif
...
// default settings
// {X, Y, Z, E}
// default steps per unit for RigidBot with standard hardware (32 tooth gear)
#define DEFAULT_AXIS_STEPS_PER_UNIT   {44.44, 22.22, 1600, 53.5}  
 // default steps for 16-tooth pulleys on x/y {100.0,50.0,1600,53.5}
 // default steps for 20-tooth pulleys on x/y {80.0, 40.0, 1600.0, 53.5}
//  RigidBot (Mk7 gear) E=53.5, E3D (Mk 8 gear)  E=76,  HPX2-MAX E=504
